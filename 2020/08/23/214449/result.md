...
* Pull request commit: [`b43a1a836b6b3e6e4a72e327d35c33589b56582d`](https://github.com/JuliaFolds/FGenerators.jl/commit/b43a1a836b6b3e6e4a72e327d35c33589b56582d)
...
## Job Properties
* Time of benchmarks:
    - Target: 23 Aug 2020 - 21:43
    - Baseline: 23 Aug 2020 - 21:44
* Package commits:
    - Target: 26701a
    - Baseline: 5373a3
* Julia commits:
...
| `["filter", ":reducer => :sum", ":impl => :base", ":src => :base"]`     |                1.08 (5%) :x: |   1.00 (1%)  |
| `["filter", ":reducer => :sum", ":impl => :xf", ":src => :base"]`       |                1.22 (5%) :x: |   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz: 
       ...
       #1  2095 MHz       4986 s          0 s       1177 s      12531 s          0 s
       #2  2095 MHz       8412 s          0 s       1486 s       8878 s          0 s
       
  Memory: 6.764881134033203 GB (3160.00390625 MB free)
  Uptime: 204.0 sec
  Load Avg:  1.40380859375  0.83154296875  0.34814453125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2095 MHz       6144 s          0 s       1208 s      14560 s          0 s
       #2  2095 MHz      10462 s          0 s       1516 s      10016 s          0 s
       
  Memory: 6.764881134033203 GB (3124.0078125 MB free)
  Uptime: 236.0 sec
  Load Avg:  1.22412109375  0.85205078125  0.3740234375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-9.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 23 Aug 2020 - 21:43
* Package commit: 26701a
* Julia commit: 96786e
...
|-------------------------------------------------------------------------|----------------:|--------:|---------------:|------------:|
| `["filter", ":reducer => :collect", ":impl => :base", ":src => :base"]` |   3.857 μs (5%) |         | 24.44 KiB (1%) |          10 |
| `["filter", ":reducer => :collect", ":impl => :base", ":src => :fgen"]` |   4.767 μs (5%) |         | 32.50 KiB (1%) |         269 |
| `["filter", ":reducer => :collect", ":impl => :xf", ":src => :base"]`   |   7.275 μs (5%) |         | 26.11 KiB (1%) |          67 |
| `["filter", ":reducer => :collect", ":impl => :xf", ":src => :fgen"]`   |   5.017 μs (5%) |         | 32.50 KiB (1%) |         269 |
| `["filter", ":reducer => :sum", ":impl => :base", ":src => :base"]`     | 758.120 ns (5%) |         | 704 bytes (1%) |          22 |
| `["filter", ":reducer => :sum", ":impl => :xf", ":src => :base"]`       |   2.070 μs (5%) |         | 880 bytes (1%) |          30 |
...
## Job Properties
* Time of benchmark: 23 Aug 2020 - 21:44
...
| `["filter", ":reducer => :collect", ":impl => :xf", ":src => :base"]`   |   6.800 μs (5%) |         | 26.11 KiB (1%) |          67 |
